<template>
<div class="w-full pt-20 flex justify-center items-center overflow-hidden">
...
<script>
    ...
    .timeline::before {
      ...
      height: 1.5rem;
      width: 1.5rem;
      border: solid 4px var(--timeline-line);
      border-radius: 50%;
      background: var(--bg);
      z-index: 1;
      transition: all .2s;
    ...
    .timeline::after {
      content: "";
      border-left: solid 3px var(--timeline-line);
      height: 100%;
      position: absolute;
      top: 0;
      left: .7rem;
    ...
    @media (min-width:640px) {
      ...
      .timeline-date span {
        ...
        clip-path: polygon(0 0, 0 0, 100% 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 15px 100%, 0 100%);
        background: var(--first-color);
        box-shadow: 4px 4px 10px var(--color-shadow-btn);
      }
